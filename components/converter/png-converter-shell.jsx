  ...
  return (
    <>
      <section className="mx-auto w-full max-w-6xl flex-1 px-4 py-8 sm:px-6 md:px-8 md:py-10">
        <ConverterHeader
          activeRoute={APP_ROUTES.TO_PNG}
          description="Convert static images to PNG locally, with resize controls and instant before-after preview."
          badges={["Static images", "Transparent output", "Local only"]}
        />
