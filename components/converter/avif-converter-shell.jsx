...
import { useAvifConversionQueue } from "@/hooks/use-avif-conversion-queue";
import {
  SETTINGS_DEFAULTS,
...
const AVIF_SETTINGS_DEFAULTS = Object.freeze({
  ...SETTINGS_DEFAULTS,
  commonOptions: {
    ...SETTINGS_DEFAULTS.commonOptions,
    quality: 50,
  },
});
...
export default function AvifConverterShell() {
  const [settings, setSettings] = useState(AVIF_SETTINGS_DEFAULTS);
  ...
  const queue = useAvifConversionQueue({
      ...
      <section className="mx-auto w-full max-w-6xl flex-1 px-6 py-10 md:px-8">
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1.6fr_1fr]">
          ...
          <SettingsPanel
            ...
            onReset={() => setSettings(AVIF_SETTINGS_DEFAULTS)}
          />
        </div>
